    ...
    public class AffectationServiceService : IAffectationServiceService
    {
        ...
        public void CreateAffectationService(AffectationService affectationService)
        {
            _applicationTraceService.create(new ApplicationTrace
            {
                ...
                description = String.Format("Affectation de l'utilisateur {0} {1} au service {2} en tant que {3}" + affectationService.groupe.libe, affectationService.employe.nom, affectationService.service.libe, affectationService.groupe.libe),
            });
        ...
        public void UpdateAffectationService(AffectationService affectationService)
        {
            ...
            {
                action = Parametres.Action.Creation.ToString(),
                description = String.Format("Mise à jour de l'affectation de l'utilisateur {0} {1} au service {2} en tant que {3}" + affectationService.groupe.libe, affectationService.employe.nom, affectationService.service.libe, affectationService.groupe.libe),
            });
