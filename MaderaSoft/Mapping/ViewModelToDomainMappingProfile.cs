...
namespace MaderaSoft.Mapping
{
    public class ViewModelToDomainMappingProfile : Profile
    {
        ...
        protected override void Configure()
        {
            ...
            CreateMap<PlanDTO, Plan>().MaxDepth(3)
               .ForMember(g => g.id, map => map.MapFrom(vm => vm.id))
               ...
               .ForMember(g => g.Etages, map => map.MapFrom(vm => vm.lesEtages));

            CreateMap<EtageDTO, Etage>().MaxDepth(3)
               .ForMember(g => g.id, map => map.MapFrom(vm => vm.id))
               .ForMember(g => g.listPositionModule, map => map.MapFrom(vm => vm.lesModules))
               .ForMember(g => g.plan, map => map.MapFrom(vm => vm.plan));

            CreateMap<PositionModuleDTO, PositionModule>().MaxDepth(3)
               .ForMember(g => g.id, map => map.MapFrom(vm => vm.id))
            ...
            CreateMap<ModuleDTO, Module>().MaxDepth(3)
               .ForMember(g => g.id, map => map.MapFrom(vm => vm.id))
               .ForMember(g => g.libe, map => map.MapFrom(vm => vm.libe))
               .ForMember(g => g.typeModule, map => map.MapFrom(vm => vm.typeModule))
